							...
							<article id="post-<?php the_ID(); ?>" <?php post_class( 'cf' ); ?> role="article">
								...
								<footer class="article-footer cf">
									<p class="footer-comment-count">
										<?php comments_number( __( '<span>No</span> Comments', 'mergehealth' ), __( '<span>One</span> Comment', 'mergehealth' ), __( '<span>%</span> Comments', 'mergehealth' ) );?>
									</p>


                 	<?php printf( '<p class="footer-category">' . __('filed under', 'mergehealth' ) . ': %1$s</p>' , get_the_category_list(', ') ); ?>
